...
import { StyleSheet, Text, View, ScrollView, Pressable, TextInput, Dimensions } from "react-native";
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 140 }}>
          ...
          <View style={styles.checkoutBlockCard}>
            ...
            <View style={styles.checkoutItemRow}>
              <View style={[styles.vegOuterBorder, { borderColor: "#16A34A" }]}><View style={[styles.vegInnerDot, { backgroundColor: "#16A34A" }]} /></View>
        ...
        <View style={styles.stickyCartStripBar}>
          ...
          <Pressable onPress={() => { alert("Order Placed Successfully!"); setCurrentScreen("home"); }} style={[styles.cartStripSubmitBtn, { backgroundColor: '#111' }]}>
...
const styles = StyleSheet.create({
  ...
  heroOrderBtnText: { color: '#FFF', fontSize: 12, fontWeight: '800' },
  ...
  mealsPrice: { color: '#FFF', fontSize: 24, fontWeight: '900', marginVertical: 4 },
  ...
  spotlightOffer: { color: '#FFF', fontSize: 24, fontWeight: '900', textShadowColor: 'rgba(0,0,0,0.5)', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 3 },
  spotlightRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: 4 },
  spotlightTitle: { color: '#FFF', fontSize: 20, fontWeight: '800' },
  ...
  feedSubtitle: { fontSize: 14, fontWeight: '700', color: '#94A3B8', marginBottom: 16 },
  ...
  navDistrictText: { color: '#FFF', fontSize: 14, fontWeight: '900', fontStyle: 'italic' },
  ...
  clearAllText: { fontSize: 14, color: '#94A3B8', fontWeight: '600' },
  ...
  headerSelectionPillText: { fontSize: 11, fontWeight: '800', color: '#EF4444' },
  ...
  radioLabel: { fontSize: 14, color: '#334155', fontWeight: '500' },
  ...
  priceSymbol: { fontSize: 15, fontWeight: '900', color: '#16A34A', marginBottom: 2, alignSelf: 'flex-start' },
  ...
  contentSectionTitle: { fontSize: 14, fontWeight: '800', color: '#0F172A', marginBottom: 12, marginTop: 14, paddingHorizontal: 16 },
  ...
  campaignRestName: { fontSize: 15, fontWeight: '900', color: '#1E293B' },
  campaignRestMetaText: { fontSize: 12, color: '#64748B', marginTop: 2 },
  campaignProductBlock: { flexDirection: 'row', marginTop: 12, gap: 12 },
  campaignProductName: { fontSize: 14, fontWeight: '700', color: '#334155' },
  ...
  campaignAddBtnText: { color: '#EF4444', fontSize: 11, fontWeight: '900' },
  gridSectionHeading: { fontSize: 14, fontWeight: '800', color: '#64748B', marginBottom: 16 },
  ...
  cuisineGridCellLabel: { fontSize: 11, fontWeight: '600', color: '#475569', marginTop: 6, textAlign: 'center' },
  ...
  inlineApplyBtnText: { color: '#3B82F6', fontSize: 11, fontWeight: '900' },
  checkoutBlockCard: { backgroundColor: '#FFF', padding: 16, borderBottomWidth: 8, borderBottomColor: '#F8FAFC' },
  checkoutBlockHeading: { fontSize: 14, fontWeight: '900', color: '#1E293B', marginBottom: 12 },
  checkoutItemRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  checkoutItemName: { fontSize: 14, color: '#334155', flex: 1 },
  checkoutItemQty: { fontSize: 13, color: '#64748B', marginRight: 12 },
  checkoutItemPrice: { fontSize: 14, fontWeight: '700', color: '#1E293B' },
  ...
  addAddressActionBtnText: { color: '#EF4444', fontSize: 14, fontWeight: '800' },
  ...
  savedAddressCardTitle: { fontSize: 14, fontWeight: '800', color: '#1E293B' },
  ...
  promoEyebrow: { fontSize: 11, color: '#92400E', fontWeight: '700' },
  promoBodyText: { fontSize: 12, color: '#B45309', marginTop: 2, lineHeight: 16 },
  promoFooterText: { fontSize: 11, color: '#16A34A', fontWeight: '700', marginTop: 2 },
  ...
  menuItemTitleNameText: { fontSize: 15, fontWeight: '700', color: '#0F172A', marginBottom: 4 },
  ...
  reorderLabelText: { fontSize: 11, color: '#64748B' },
  menuItemPriceVal: { fontSize: 14, fontWeight: '700', color: '#0F172A', marginBottom: 5 },
  ...
  qtyValueDisplayLabel: { paddingVertical: 5, paddingHorizontal: 2, fontSize: 14, fontWeight: '800', color: '#EF4444', minWidth: 18, textAlign: 'center' },
  ...
  nativeAddButtonPillText: { color: '#EF4444', fontSize: 14, fontWeight: '800' },
  nativeAddButtonPillPlusSign: { fontSize: 15, fontWeight: '900', color: '#EF4444' },
  ...
  floatingMenuPillBtnText: { color: '#fff', fontSize: 14, fontWeight: '700' },
  ...
  cartStripSubtext: { color: 'rgba(255,255,255,0.75)', fontSize: 11 },
  cartStripPriceValText: { color: '#fff', fontSize: 15, fontWeight: '900' },
  ...
  drawSheetHeadingTitleText: { fontSize: 15, fontWeight: '800', color: '#0F172A' },
