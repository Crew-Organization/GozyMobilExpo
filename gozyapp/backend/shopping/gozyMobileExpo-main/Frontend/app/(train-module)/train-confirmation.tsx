      ...
      <View style={styles.screen}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.premiumActionsRow}>
            ...
            <Pressable onPress={() => Alert.alert('Download E-Ticket', 'Downloading secure PDF e-ticket...')} style={styles.premiumOutlineBtn}>
              <Text style={styles.premiumOutlineBtnText}>Download E-Ticket ↗</Text>
            </Pressable>
          </View>
          ...
          <View style={styles.sectionCard}>
            <View style={styles.pnrSubheaderRow}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                <Pressable hitSlop={6} onPress={() => Alert.alert('Refreshing PNR...', 'Current status: Confirmed')} style={styles.refreshBtn}>
          ...
          <View style={styles.sectionCard}>
            ...
            >
              <Text style={styles.cancellationLinkActionText}>Cancel Booking</Text>
