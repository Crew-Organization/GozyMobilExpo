      ...
      <ScreenShell scroll={true} contentContainerStyle={styles.shellContainer}>
        ...
        <View style={styles.carouselContainer}>
          ...
          <View style={{ position: 'absolute', bottom: 12, left: 12, backgroundColor: 'rgba(255, 255, 255, 0.95)', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 14, gap: 2, borderWidth: 1, borderColor: '#EAEAEC' }}>
            <Text style={{ fontSize: 11, fontWeight: '900', color: '#282C3F' }}>{calculatedRatings.averageRating.toFixed(1)}</Text>
            ...
            <Text style={{ fontSize: 11, color: '#7E8190', fontWeight: '800' }}>
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.priceRow}>
            <Text style={{ fontSize: 14, color: '#7E8190', fontWeight: '500', textDecorationLine: 'line-through' }}>
          ...
          <Text style={{ fontSize: 11, color: '#03A685', fontWeight: '700', marginTop: -4 }}>Inclusive of all taxes</Text>
          ...
          <View style={{ marginTop: 12, borderWidth: 1, borderColor: '#FCE7F3', borderRadius: 8, padding: 12, backgroundColor: '#FFF5F7', gap: 8 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              <Text style={{ fontSize: 11, color: '#7E8190', fontWeight: '500' }}>With Coupon + Bank Offer</Text>
              <Text style={{ fontSize: 11, color: '#FF3F6C', fontWeight: '800' }}>Details &gt;</Text>
            </View>
          </View>
        </View>
            ...
            {displaySizes.map((sz) => {
              ...
              return (
                <View key={sz.value} style={{ alignItems: 'center', gap: 6 }}>
                  ...
                  >
                    <Text style={{ fontSize: 14, fontWeight: '800', color: isSelected ? '#FF3F6C' : '#282C3F' }}>
                      {sz.value}
                    </Text>
                    {!isAvailable && (
        ...
        <View style={{ padding: 16, borderBottomWidth: 1, borderColor: '#EAEAEC', gap: 12 }}>
          ...
          <View style={{ borderWidth: 1, borderColor: '#FFF0F2', borderRadius: 8, padding: 12, backgroundColor: '#FFF5F7', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, flex: 1 }}>
              ...
              <View style={{ gap: 2, flex: 1 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                  ...
                  <Text style={{ fontSize: 11, fontWeight: '900', color: '#282C3F' }}>STANDARD</Text>
                </View>
            ...
            <View style={{ alignItems: 'flex-end' }}>
              ...
              <Text style={{ fontSize: 11, color: '#03A685', fontWeight: '800' }}>Rs. {product.price.toLocaleString('en-IN')} ({discountPercent}% OFF)</Text>
            </View>
          </View>
          ...
          <View style={{ gap: 8, marginTop: 4 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
              ...
              <View>
                ...
                <Text style={{ fontSize: 11, color: '#7E8190', fontWeight: '500' }}>Rs. 10 additional fee applicable</Text>
              </View>
            </View>
        ...
        <View style={styles.reviewsSection}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', paddingVertical: 16, borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#EAEAEC', marginTop: 12 }}>
            ...
            <View style={{ alignItems: 'center', gap: 6, flex: 1 }}>
              ...
              <Text style={{ fontSize: 11, fontWeight: '800', color: '#282C3F', textAlign: 'center' }}>Genuine Product</Text>
            </View>
            ...
            <View style={{ alignItems: 'center', gap: 6, flex: 1 }}>
              ...
              <Text style={{ fontSize: 11, fontWeight: '800', color: '#282C3F', textAlign: 'center' }}>Quality Checked</Text>
            </View>
          </View>

          {/* More Information */}
          <View style={{ paddingVertical: 8, gap: 4 }}>
            <Text style={{ fontSize: 11, color: '#9496A2', fontWeight: '600' }}>Product Code: 34131940</Text>
