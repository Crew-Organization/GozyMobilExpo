...
export default function SuperAppDashboard() {
  ...
  const handleFeaturePress = (id?: string) => {
    ...
    else if (id === 'trains') router.push('/train');
    else if (id === 'cabs') router.push('/cab');
    else if (id === 'movies' || id === 'entertainment')
      router.push('/(movies-module)/movies');
    else if (id === 'events') router.push('/(movies-module)/movies');
    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.discoverCard}>
          ...
          <Pressable onPress={() => router.push('/train-pnr-check' as any)} style={styles.discoverItem}>
