...
type AppContextValue = {
  ...
  createHotelBooking: (payload: any) => Promise<any>;
...
export function AppProvider({ children }: PropsWithChildren) {
  ...
  const createHotelBooking = async (payload: any) => {
    const confirmation = {
      id: makeId('hotel-booking'),
      ...
      tripSecure: payload.tripSecure,
      paymentMethod: payload.paymentMethod,
    };
    
    const booking: Booking = {
      id: confirmation.id,
      experienceId: confirmation.hotelId,
      title: 'Stay Booking',
      category: 'Travel',
      location: 'Hyderabad',
    ...
    sendLocalNotification(
      ...
      `Your room booking is now available in your Gozy bookings.`,
    );
    return confirmation;
  };
