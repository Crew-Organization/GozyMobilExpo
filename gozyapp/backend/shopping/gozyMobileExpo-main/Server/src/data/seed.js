const seedData = {
  session: {
    ...
    user: {
      ...
      city: 'Bengaluru',
      interests: ['Weekend trips', 'Cafe hopping', 'Streetwear'],
      budget: 'Rs 15k - 25k',
      homeAirport: 'BLR',
  ...
  feed: [
    {
      ...
      description:
        'Cliff viewpoints, hidden beach cafes, and a route optimized for sunrise, fuel, and social stops.',
      posterUrl:
        'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80',
      videoUrl:
        'https://assets.mixkit.co/videos/preview/mixkit-driving-through-a-beautiful-jungle-road-15180-large.mp4',
    ...
    },
    {
      ...
      description:
        'Short tasting menu clips, live table availability, delivery fallback, and split-pay checkout.',
      posterUrl:
    ...
    },
    {
      ...
      location: 'Bengaluru, India',
      description:
        'Swipe outfit reels, compare variants, save to a wardrobe board, and unlock cashback for pickup.',
      posterUrl:
        'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?auto=format&fit=crop&w=1200&q=80',
      videoUrl:
        'https://assets.mixkit.co/videos/preview/mixkit-woman-with-shopping-bags-walking-in-the-city-4571-large.mp4',
    ...
    },
    {
      ...
      description:
        'Buy movie tickets, find dessert stops, and invite friends or matched travelers into the same plan.',
      posterUrl:
  ...
  travelInventory: [
    {
      routeKey: 'BLR-GOI',
      aiTip:
        'Gozy AI recommends the early morning non-stop bank for Goa. It lands before hotel check-in traffic and protects more beach time for the same budget.',
      priceInsight: {
