...
export const mockEvents: EventListing[] = [
  {
    id: 'event-khushkhabri',
    title: 'Khushkhabri',
    venue: 'Cinepolis: Pacific Mall, Sonipat',
    date: 'Today, 6:15 PM',
    genre: 'Movie',
    image:
      'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    venue: 'PVR IMAX: Pacific Mall, Sonipat',
    date: 'Today, 8:40 PM',
    genre: 'Movie',
    image:
  ...
  {
    id: 'event-gt',
    title: 'Gujarat Titans Registration - IPL 2026',
  ...
  {
    id: 'event-mi',
    title: 'Mumbai Indians Registration - IPL 2026',
  ...
  {
    id: 'event-comedy',
    title: 'No Waiting Lines For Fam',
    venue: 'Phoenix Arena, Delhi NCR',
    date: 'Fri, 7:00 PM',
    genre: 'Comedy',
    image:
