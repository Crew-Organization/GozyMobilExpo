  ...
  return (
    <Animated.View
      ...
      <View style={styles.bottomContent}>
        ...
        <View style={{ position: 'absolute', right: 16, bottom: 90, alignItems: 'center', gap: 20 }}>
          <Pressable style={{ alignItems: 'center', gap: 4 }}>
            <MaterialCommunityIcons name="heart-outline" size={32} color="#fff" />
            <Text style={{ color: '#fff', fontSize: 12, fontWeight: '600' }}>12.4K</Text>
          </Pressable>
          <Pressable style={{ alignItems: 'center', gap: 4 }}>
            <MaterialCommunityIcons name="comment-processing-outline" size={30} color="#fff" />
            <Text style={{ color: '#fff', fontSize: 12, fontWeight: '600' }}>428</Text>
          </Pressable>
          <Pressable style={{ alignItems: 'center', gap: 4 }}>
