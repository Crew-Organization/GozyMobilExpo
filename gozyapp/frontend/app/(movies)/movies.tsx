...
import {
  ...
  Dimensions, Modal, FlatList, Animated, Linking, ActivityIndicator
} from "react-native";
...
function PaymentScreen({
  ...
  const handlePayment = (methodId: string) => {
    ...
    setTimeout(() => {
      ...
      // Step 1: Processing Payment (3s)
      setTimeout(() => {
        setPaymentStep(2); // Success
        
        // Step 2: Confirmation redirection (1.5s)
        setTimeout(() => {
...
const s = StyleSheet.create({
  ...
  citySearchInput: { flex: 1, fontSize: 13, color: palette.textDark },
  ...
  popularName: { fontSize: 10.5, fontWeight: '500', color: palette.text, marginTop: 6, textAlign: 'center' },
  ...
  cityItemText: { fontSize: 13, color: palette.text },
  ...
  homeSearchInput: { flex: 1, fontSize: 13, color: palette.textDark },
  ...
  bannerEyebrow: { fontSize: 10.5, color: 'rgba(255,255,255,0.65)', fontWeight: '600' },
  ...
  bannerCTAText: { color: '#0F172A', fontSize: 10.5, fontWeight: '700' },
  ...
  movieRatingText: { color: '#FFF', fontSize: 10.5, fontWeight: '800' },
  ...
  movieGenre: { fontSize: 10.5, color: palette.textMuted, marginTop: 2 },
  ...
  eventTitle: { fontSize: 13, fontWeight: '800', color: palette.textDark, marginBottom: 6 },
  eventDetailRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 3 },
  eventDetailText: { fontSize: 10.5, color: palette.textMuted },
  ...
  exploreCatLabel: { color: '#FFF', fontSize: 10.5, fontWeight: '700', textAlign: 'center' },
  ...
  streamTitle: { color: '#FFF', fontSize: 13, fontWeight: '800' },
  streamSub: { color: 'rgba(255,255,255,0.6)', fontSize: 10.5, marginTop: 2 },
  ...
  profileBannerSub: { fontSize: 10.5, color: palette.textMuted },
  profileAddBtn: { backgroundColor: palette.accent, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 6 },
  profileAddBtnText: { color: '#111827', fontSize: 12, fontWeight: '700' },
  ...
  filterSectionTitle: { fontSize: 13, fontWeight: '700', color: palette.textDark, paddingHorizontal: 16, marginTop: 18, marginBottom: 10 },
  ...
  filtersApplyText: { color: '#FFF', fontSize: 13, fontWeight: '800' },
  ...
  rateBtnText: { color: '#111827', fontSize: 12, fontWeight: '700' },

  detailInfoSection: { paddingHorizontal: 16, paddingTop: 16 },
  detailTitle: { fontSize: 18, fontWeight: '900', color: palette.textDark, letterSpacing: -0.3 },
  ...
  castName: { fontSize: 10.5, fontWeight: '600', color: palette.text, marginTop: 6, textAlign: 'center' },
  ...
  offerSub: { fontSize: 10.5, color: palette.textMuted, marginTop: 2 },
  ...
  bookBtnText: { color: '#111827', fontSize: 16, fontWeight: '900' },
  ...
  theaterHeaderSub: { fontSize: 10.5, color: palette.textMuted, marginTop: 1 },
  ...
  theaterName: { fontSize: 13, fontWeight: '700', color: palette.textDark },
  theaterArea: { fontSize: 10.5, color: palette.textMuted, marginTop: 1 },
  ...
  seatCountLabel: { fontSize: 13, fontWeight: '700', color: palette.textDark, marginBottom: 10 },
  ...
  seatCategoryLabel: { fontSize: 10.5, fontWeight: '800', letterSpacing: 1 },
  ...
  seatLegendText: { fontSize: 10.5, color: palette.textMuted, fontWeight: '500' },
  ...
  seatPayBtnText: { color: '#111827', fontSize: 13, fontWeight: '800' },
  ...
  summaryShowtime: { fontSize: 10.5, color: palette.textMuted, marginTop: 2 },
  ...
  billHeading: { fontSize: 13, fontWeight: '800', color: palette.textDark, marginBottom: 14 },
  ...
  billTotalLabel: { fontSize: 13, fontWeight: '900', color: palette.textDark },
  ...
  termsText: { fontSize: 10.5, color: palette.textMuted, lineHeight: 16, flex: 1 },
  ...
  inputField: { flex: 1, fontSize: 13, color: palette.textDark },
  phonePrefix: { fontSize: 13, fontWeight: '700', color: palette.textDark },
  ...
  recapTitle: { fontSize: 13, fontWeight: '700', color: palette.textDark },
  recapMeta: { fontSize: 10.5, color: palette.textMuted, marginTop: 3 },
  ...
  confirmTitle: { fontSize: 18, fontWeight: '900', color: palette.textDark, marginBottom: 6 },
  confirmSub: { fontSize: 13, color: palette.textMuted, marginBottom: 28 },
  ...
  confirmTotalLabel: { fontSize: 13, fontWeight: '700', color: palette.textDark },
  confirmTotalValue: { fontSize: 18, fontWeight: '900', color: palette.success },
  confirmDoneBtn: { backgroundColor: palette.accent, paddingVertical: 14, borderRadius: 10, alignItems: 'center', marginTop: 28 },
  confirmDoneBtnText: { color: '#111827', fontSize: 13, fontWeight: '800' },
  ...
  cbMovieLang: { fontSize: 10.5, color: palette.textMuted, marginBottom: 2 },
  cbTheater: { fontSize: 10.5, color: palette.textMuted, marginBottom: 4 },
  ...
  cbCancelSub: { fontSize: 10.5, color: '#92400E', lineHeight: 16 },
  ...
  cbBillAddText: { fontSize: 10.5, fontWeight: '700', color: palette.accent },
  cbBillTotalRow: { borderTopWidth: 1, borderTopColor: palette.line, paddingTop: 12, marginBottom: 0 },
  cbBillTotalLabel: { fontSize: 13, fontWeight: '900', color: palette.textDark },
  cbBillTotalValue: { fontSize: 13, fontWeight: '900', color: palette.textDark },
  ...
  cbContactAddress: { fontSize: 10.5, color: palette.textMuted, marginTop: 2 },
  ...
  cbOfferText: { fontSize: 13, fontWeight: '700', color: palette.textDark },
  ...
  cbConsentText: { fontSize: 10.5, color: palette.textMuted, lineHeight: 16 },
  ...
  cbContinueBtnText: { color: '#111827', fontSize: 13, fontWeight: '800' },
  ...
  pmAmountLabel: { fontSize: 13, fontWeight: '600', color: palette.text },
  ...
  pmMethodLabel: { fontSize: 13, fontWeight: '600', color: palette.textDark },
  pmMethodSub: { fontSize: 10.5, color: palette.textMuted, marginTop: 2 },

  pmBrandRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', paddingVertical: 24, gap: 10 },
  pmBrandText: { fontSize: 18, fontWeight: '900', color: palette.muted, fontStyle: 'italic', letterSpacing: 2 },
  pmBrandIcon: { },
  ...
  pmNoteText: { fontSize: 10.5, color: palette.textMuted, lineHeight: 18, marginBottom: 4 },
  ...
  pmSafeLogoText: { fontSize: 10.5, fontWeight: '800' },
  ...
  upiAppLabel: { flex: 1, fontSize: 13, fontWeight: '600', color: palette.textDark },
});
