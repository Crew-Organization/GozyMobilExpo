  ...
  return (
    <ScreenShell>
      <TopBar
        ...
        secondaryAction={{ icon: 'cart-outline', onPress: () => router.push('/food-payment') }}
      ...
      {foodCart.length > 0 ? (
        <Pressable onPress={() => router.push('/food-payment')} style={styles.checkoutBar}>
          <Text style={styles.checkoutBarText}>Continue to payment</Text>
        </Pressable>
      ) : null}
    </ScreenShell>
  );
