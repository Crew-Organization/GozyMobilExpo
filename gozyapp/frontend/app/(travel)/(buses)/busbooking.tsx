  ...
  return (
    <View style={styles.root}>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.tripAssuredBanner}>
            <View style={styles.tripAssuredContent}>
              <Text style={styles.tripAssuredTitle}>Get <Text style={{color: '#16A34A'}}>2x</Text> Refund with TripAssured</Text>
              <Text style={styles.tripAssuredSubtitle}>Your protection against unexpected bus cancellations.</Text>
              <Pressable style={styles.tripAssuredCta}>
                <Text style={styles.tripAssuredCtaText}>Know more</Text>
                <MaterialCommunityIcons name="arrow-right" size={12} color="#FFF" />
              </Pressable>
            </View>
            <MaterialCommunityIcons name="shield-check" size={48} color="#16A34A" style={styles.tripAssuredIcon} />
          </View>
          ...
          <Section icon="star" title="NEW FEATURES!">
            <ScrollView horizontal contentContainerStyle={styles.featureRail} showsHorizontalScrollIndicator={false}>
              <View style={[styles.featureCard, {backgroundColor: '#F3F4F6'}]}>
                <View style={[styles.featureIconWrap, {backgroundColor: '#EAEBFF'}]}>
                  <Text style={styles.featureIconText}>Prime</Text>
                </View>
                <View style={styles.featureTextWrap}>
                  <Text style={styles.featureTitle}>Travel with a Prime bus</Text>
                  <Text style={styles.featureSubtitle}>Enjoy the best-in-class services and amenities for no extra charge.</Text>
                  <Text style={styles.featureLink}>Learn More</Text>
                </View>
              </View>
              <View style={[styles.featureCard, {backgroundColor: '#FEF9C3'}]}>
                <View style={[styles.featureIconWrap, {backgroundColor: '#FEF3C7'}]}>
                  <MaterialCommunityIcons name="ticket-percent" size={24} color="#D97706" />
                </View>
                <View style={styles.featureTextWrap}>
                  <Text style={styles.featureTitle}>Enjoy Assured discounts</Text>
                  <Text style={styles.featureSubtitle}>Travel with select partner operators and save big on your next trip.</Text>
                  <Text style={styles.featureLink}>Learn More</Text>
                </View>
              </View>
            </ScrollView>
          ...
          <View style={styles.adBanner}>
            <Image 
              source={{ uri: 'https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=600&h=300&fit=crop' }} 
              style={styles.adBannerImage} 
            />
            <LinearGradient colors={['rgba(0,0,0,0)', 'rgba(0,0,0,0.8)']} style={styles.adBannerOverlay} />
            <View style={styles.adBannerContent}>
              <Text style={styles.adBannerTitle}>Your next getaway starts with payday.</Text>
              <View style={styles.adBannerBadge}>
                <Text style={styles.adBannerBadgeText}>Canara Bank</Text>
              </View>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  fieldValue: { color: '#191919', fontSize: 13, fontWeight: '900' },
  ...
  tripAssuredContent: { flex: 1, gap: 4 },
  tripAssuredTitle: { fontSize: 14, fontWeight: '800', color: '#1F2937' },
  tripAssuredSubtitle: { fontSize: 11, color: '#4B5563', fontWeight: '600' },
  tripAssuredCta: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  tripAssuredCtaText: { color: '#FFF', fontSize: 10, fontWeight: '800' },
  tripAssuredIcon: { marginLeft: 12 },
  featureRail: { paddingHorizontal: 16, gap: 12, paddingBottom: 8 },
  featureCard: { width: 280, borderRadius: 8, flexDirection: 'row', padding: 12, gap: 12, borderWidth: 1, borderColor: '#E5E7EB' },
  featureIconWrap: { width: 40, height: 40, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  featureIconText: { fontSize: 12, fontWeight: '900', color: '#4338CA' },
  featureTextWrap: { flex: 1, gap: 2 },
  featureTitle: { fontSize: 14, fontWeight: '800', color: '#111827' },
  featureSubtitle: { fontSize: 10, color: '#4B5563', fontWeight: '600' },
  featureLink: { fontSize: 11, fontWeight: '800', color: '#2563EB', marginTop: 4 },
  adBanner: {
    marginHorizontal: 16,
    height: 140,
    borderRadius: 8,
  ...
  adBannerOverlay: { ...StyleSheet.absoluteFillObject },
  adBannerContent: { position: 'absolute', bottom: 12, left: 12, right: 12 },
  adBannerTitle: { color: '#FFF', fontSize: 18, fontWeight: '900', textShadowColor: 'rgba(0,0,0,0.5)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  adBannerBadge: { alignSelf: 'flex-start', backgroundColor: '#FFF', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, marginTop: 6 },
  adBannerBadgeText: { fontSize: 10, fontWeight: '800', color: '#0F172A' },
});
